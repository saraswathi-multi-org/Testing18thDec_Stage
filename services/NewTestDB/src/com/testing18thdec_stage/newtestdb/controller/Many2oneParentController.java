...
public class Many2oneParentController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Many2oneParent getMany2oneParent(@PathVariable("id") String id) throws EntityNotFoundException {
        LOGGER.debug("Getting Many2oneParent with id: {}" , id);

        Many2oneParent foundMany2oneParent = many2oneParentService.getById(id);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Many2oneParent editMany2oneParent(@PathVariable("id") String id, @RequestBody Many2oneParent many2oneParent) throws EntityNotFoundException {
        LOGGER.debug("Editing Many2oneParent with id: {}" , many2oneParent.getStringId());

        many2oneParent.setStringId(id);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteMany2oneParent(@PathVariable("id") String id) throws EntityNotFoundException {
        LOGGER.debug("Deleting Many2oneParent with id: {}" , id);

        Many2oneParent deletedMany2oneParent = many2oneParentService.delete(id);
    ...
    public Page<Many2oneParent> searchMany2oneParentsByQueryFilters( Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering Many2oneParents list");
	...
	@ApiOperation(value = "Returns the total count of Many2oneParent instances matching the optional query (q) request param. If query string is too big to fit in GET request's query param, use POST method with application/x-www-form-urlencoded format.")
    ...
    @RequestMapping(value="/{id:.+}/many2oneChilds", method=RequestMethod.GET)
    @ApiOperation(value = "Gets the many2oneChilds instance associated with the given id.")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<Many2oneChild> findAssociatedMany2oneChilds(@PathVariable("id") String id, Pageable pageable) {

        LOGGER.debug("Fetching all associated many2oneChilds");
        return many2oneParentService.findAssociatedMany2oneChilds(id, pageable);
    }

...
public class Many2oneCompChildController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Many2oneCompChild getMany2oneCompChild(@PathVariable("id") Short id) throws EntityNotFoundException {
        LOGGER.debug("Getting Many2oneCompChild with id: {}" , id);

        Many2oneCompChild foundMany2oneCompChild = many2oneCompChildService.getById(id);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Many2oneCompChild editMany2oneCompChild(@PathVariable("id") Short id, @RequestBody Many2oneCompChild many2oneCompChild) throws EntityNotFoundException {
        LOGGER.debug("Editing Many2oneCompChild with id: {}" , many2oneCompChild.getShortId());

        many2oneCompChild.setShortId(id);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteMany2oneCompChild(@PathVariable("id") Short id) throws EntityNotFoundException {
        LOGGER.debug("Deleting Many2oneCompChild with id: {}" , id);

        Many2oneCompChild deletedMany2oneCompChild = many2oneCompChildService.delete(id);

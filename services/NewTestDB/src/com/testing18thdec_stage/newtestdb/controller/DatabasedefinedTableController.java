...
@ApiOperation(value = "Returns the DatabasedefinedTable instance associated with the given composite-id.")
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public DatabasedefinedTable getDatabasedefinedTable(@RequestParam("a") Integer a,@RequestParam("b") Integer b,@RequestParam("expires") LocalDateTime expires,@RequestParam("x") byte[] x,@RequestParam("column5") String column5) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public DatabasedefinedTable editDatabasedefinedTable(@RequestParam("a") Integer a,@RequestParam("b") Integer b,@RequestParam("expires") LocalDateTime expires,@RequestParam("x") byte[] x,@RequestParam("column5") String column5, @RequestBody DatabasedefinedTable databasedefinedTable) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public DatabasedefinedTable editDatabasedefinedTable(@RequestParam("a") Integer a,@RequestParam("b") Integer b,@RequestParam("expires") LocalDateTime expires,@RequestParam("x") byte[] x,@RequestParam("column5") String column5, MultipartHttpServletRequest multipartHttpServletRequest) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public DatabasedefinedTable editDatabasedefinedTableAndMultiparts(@RequestParam("a") Integer a,@RequestParam("b") Integer b,@RequestParam("expires") LocalDateTime expires,@RequestParam("x") byte[] x,@RequestParam("column5") String column5, MultipartHttpServletRequest multipartHttpServletRequest) throws EntityNotFoundException { 
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteDatabasedefinedTable(@RequestParam("a") Integer a,@RequestParam("b") Integer b,@RequestParam("expires") LocalDateTime expires,@RequestParam("x") byte[] x,@RequestParam("column5") String column5) throws EntityNotFoundException {
    ...
    public Page<DatabasedefinedTable> searchDatabasedefinedTablesByQueryFilters( Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering DatabasedefinedTables list");
	...
	@ApiOperation(value = "Returns the total count of DatabasedefinedTable instances matching the optional query (q) request param. If query string is too big to fit in GET request's query param, use POST method with application/x-www-form-urlencoded format.")

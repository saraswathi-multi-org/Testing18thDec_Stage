...
public class One2oneChildController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public One2oneChild getOne2oneChild(@PathVariable("pkId") Short pkId) {
        LOGGER.debug("Getting One2oneChild with id: {}" , pkId);

        One2oneChild foundOne2oneChild = one2oneChildService.getById(pkId);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public One2oneChild editOne2oneChild(@PathVariable("pkId") Short pkId, @RequestBody One2oneChild one2oneChild) {
        LOGGER.debug("Editing One2oneChild with id: {}" , one2oneChild.getPkId());

        one2oneChild.setPkId(pkId);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public One2oneChild patchOne2oneChild(@PathVariable("pkId") Short pkId, @RequestBody @MapTo(One2oneChild.class) Map<String, Object> one2oneChildPatch) {
        LOGGER.debug("Partially updating One2oneChild with id: {}" , pkId);

        One2oneChild one2oneChild = one2oneChildService.partialUpdate(pkId, one2oneChildPatch);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteOne2oneChild(@PathVariable("pkId") Short pkId) {
        LOGGER.debug("Deleting One2oneChild with id: {}" , pkId);

        One2oneChild deletedOne2oneChild = one2oneChildService.delete(pkId);

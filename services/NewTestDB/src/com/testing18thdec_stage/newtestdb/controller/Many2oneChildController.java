...
public class Many2oneChildController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Many2oneChild getMany2oneChild(@PathVariable("id") Integer id) throws EntityNotFoundException {
        LOGGER.debug("Getting Many2oneChild with id: {}" , id);

        Many2oneChild foundMany2oneChild = many2oneChildService.getById(id);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Many2oneChild editMany2oneChild(@PathVariable("id") Integer id, @RequestBody Many2oneChild many2oneChild) throws EntityNotFoundException {
        LOGGER.debug("Editing Many2oneChild with id: {}" , many2oneChild.getByteid());

        many2oneChild.setByteid(id);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteMany2oneChild(@PathVariable("id") Integer id) throws EntityNotFoundException {
        LOGGER.debug("Deleting Many2oneChild with id: {}" , id);

        Many2oneChild deletedMany2oneChild = many2oneChildService.delete(id);
    ...
    public Page<Many2oneChild> searchMany2oneChildsByQueryFilters( Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering Many2oneChilds list");
	...
	@ApiOperation(value = "Returns the total count of Many2oneChild instances matching the optional query (q) request param. If query string is too big to fit in GET request's query param, use POST method with application/x-www-form-urlencoded format.")

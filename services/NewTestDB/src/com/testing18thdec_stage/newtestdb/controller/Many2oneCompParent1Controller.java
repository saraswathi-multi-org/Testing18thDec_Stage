...
@ApiOperation(value = "Returns the Many2oneCompParent1 instance associated with the given composite-id.")
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Many2oneCompParent1 getMany2oneCompParent1(@RequestParam("stringPk") String stringPk,@RequestParam("bigintPk") Long bigintPk,@RequestParam("charPk") String charPk,@RequestParam("booleanPk") Boolean booleanPk) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Many2oneCompParent1 editMany2oneCompParent1(@RequestParam("stringPk") String stringPk,@RequestParam("bigintPk") Long bigintPk,@RequestParam("charPk") String charPk,@RequestParam("booleanPk") Boolean booleanPk, @RequestBody Many2oneCompParent1 many2oneCompParent1) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteMany2oneCompParent1(@RequestParam("stringPk") String stringPk,@RequestParam("bigintPk") Long bigintPk,@RequestParam("charPk") String charPk,@RequestParam("booleanPk") Boolean booleanPk) throws EntityNotFoundException {
    ...
    public Page<Many2oneCompParent1> searchMany2oneCompParent1sByQueryFilters( Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering Many2oneCompParent1s list");
	...
	@ApiOperation(value = "Returns the total count of Many2oneCompParent1 instances matching the optional query (q) request param. If query string is too big to fit in GET request's query param, use POST method with application/x-www-form-urlencoded format.")
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<Many2oneCompChild1> findAssociatedMany2oneCompChild1s(@RequestParam("stringPk") String stringPk,@RequestParam("bigintPk") Long bigintPk,@RequestParam("charPk") String charPk,@RequestParam("booleanPk") Boolean booleanPk, Pageable pageable) {

        LOGGER.debug("Fetching all associated many2oneCompChild1s");
        return many2oneCompParent1Service.findAssociatedMany2oneCompChild1s(stringPk, bigintPk, charPk, booleanPk, pageable);
    }

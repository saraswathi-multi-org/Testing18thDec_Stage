...
import com.testing18thdec_stage.newtestdb.service.Many2oneCompParentService;
...
public class Many2oneCompParentController {
    ...
    @Autowired
	@Qualifier("NewTestDB.Many2oneCompParentService")
    ...
    public Many2oneCompParent createMany2oneCompParent(@RequestPart("wm_data_json") Many2oneCompParent many2oneCompParent, @RequestPart(value = "blobCol", required = false) MultipartFile _blobCol) {
		LOGGER.debug("Create Many2oneCompParent with information: {}" , many2oneCompParent);

    many2oneCompParent.setBlobCol(WMMultipartUtils.toByteArray(_blobCol));
...
@ApiOperation(value = "Returns the Many2oneCompParent instance associated with the given composite-id.")
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Many2oneCompParent getMany2oneCompParent(@RequestParam("floatId") Double floatId,@RequestParam("charId") String charId,@RequestParam("stringId") String stringId,@RequestParam("doubleCol") BigDecimal doubleCol) throws EntityNotFoundException {
        ...
        many2onecompparentId.setDoubleCol(doubleCol);
    ...
    @ApiOperation(value = "Retrieves content for the given BLOB field in Many2oneCompParent instance associated with the given composite-id.")
    @RequestMapping(value = "/composite-id/content/{fieldName}", method = RequestMethod.GET)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public void getMany2oneCompParentBLOBContent(@RequestParam("floatId") Double floatId,@RequestParam("charId") String charId,@RequestParam("stringId") String stringId,@RequestParam("doubleCol") BigDecimal doubleCol, @PathVariable("fieldName") String fieldName, HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) throws EntityNotFoundException {

        LOGGER.debug("Retrieves content for the given BLOB field {} in Many2oneCompParent instance" , fieldName);

        if(!WMRuntimeUtils.isLob(Many2oneCompParent.class, fieldName)) {
        ...
        Many2oneCompParent many2oneCompParent = many2oneCompParentService.getById(many2onecompparentId);
        WMMultipartUtils.buildHttpResponseForBlob(many2oneCompParent, fieldName, httpServletRequest, httpServletResponse);
    }
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Many2oneCompParent editMany2oneCompParent(@RequestParam("floatId") Double floatId,@RequestParam("charId") String charId,@RequestParam("stringId") String stringId,@RequestParam("doubleCol") BigDecimal doubleCol, @RequestBody Many2oneCompParent many2oneCompParent) throws EntityNotFoundException {

        many2oneCompParent.setFloatId(floatId);
        many2oneCompParent.setCharId(charId);
        many2oneCompParent.setStringId(stringId);
        many2oneCompParent.setDoubleCol(doubleCol);
    ...
    @ApiOperation(value = "Updates the Many2oneCompParent instance associated with the given composite-id.This API should be used when Many2oneCompParent instance fields that require multipart data.")
    @RequestMapping(value = "/composite-id", method = RequestMethod.POST, consumes = "multipart/form-data")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Many2oneCompParent editMany2oneCompParent(@RequestParam("floatId") Double floatId,@RequestParam("charId") String charId,@RequestParam("stringId") String stringId,@RequestParam("doubleCol") BigDecimal doubleCol, MultipartHttpServletRequest multipartHttpServletRequest) throws EntityNotFoundException {
        return this.editMany2oneCompParentAndMultiparts(floatId, charId, stringId, doubleCol, multipartHttpServletRequest);
    }

    @ApiOperation(value = "Updates the Many2oneCompParent instance associated with the given composite-id.")
    @RequestMapping(value = "/composite-id", method = RequestMethod.PUT,  consumes = "multipart/form-data")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Many2oneCompParent editMany2oneCompParentAndMultiparts(@RequestParam("floatId") Double floatId,@RequestParam("charId") String charId,@RequestParam("stringId") String stringId,@RequestParam("doubleCol") BigDecimal doubleCol, MultipartHttpServletRequest multipartHttpServletRequest) throws EntityNotFoundException { 
        ...
        Many2oneCompParent newMany2oneCompParent = WMMultipartUtils.toObject(multipartHttpServletRequest, Many2oneCompParent.class, "NewTestDB");
        Many2oneCompParent oldMany2oneCompParent = many2oneCompParentService.getById(many2onecompparentId);

        WMMultipartUtils.updateLobsContent(oldMany2oneCompParent, newMany2oneCompParent);

        newMany2oneCompParent.setFloatId(floatId);
        newMany2oneCompParent.setCharId(charId);
        newMany2oneCompParent.setStringId(stringId);
        newMany2oneCompParent.setDoubleCol(doubleCol);

        LOGGER.debug("Many2oneCompParent details with id is updated with: {}" , newMany2oneCompParent);

        return many2oneCompParentService.update(newMany2oneCompParent);
    }
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteMany2oneCompParent(@RequestParam("floatId") Double floatId,@RequestParam("charId") String charId,@RequestParam("stringId") String stringId,@RequestParam("doubleCol") BigDecimal doubleCol) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<Many2oneCompChild> findAssociatedMany2oneCompChilds(@RequestParam("floatId") Double floatId,@RequestParam("charId") String charId,@RequestParam("stringId") String stringId,@RequestParam("doubleCol") BigDecimal doubleCol, Pageable pageable) {

        LOGGER.debug("Fetching all associated many2oneCompChilds");
        return many2oneCompParentService.findAssociatedMany2oneCompChilds(floatId, charId, stringId, doubleCol, pageable);
    }

...
public class Many2oneCompParentController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Many2oneCompParent getMany2oneCompParent(@RequestParam("stringId") String stringId, @RequestParam("floatId") Double floatId, @RequestParam("doubleCol") BigDecimal doubleCol, @RequestParam("charId") String charId) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public void getMany2oneCompParentBLOBContent(@RequestParam("stringId") String stringId, @RequestParam("floatId") Double floatId, @RequestParam("doubleCol") BigDecimal doubleCol, @RequestParam("charId") String charId, @PathVariable("fieldName") String fieldName, HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Many2oneCompParent editMany2oneCompParent(@RequestParam("stringId") String stringId, @RequestParam("floatId") Double floatId, @RequestParam("doubleCol") BigDecimal doubleCol, @RequestParam("charId") String charId, @RequestBody Many2oneCompParent many2oneCompParent) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Many2oneCompParent patchMany2oneCompParent(@RequestParam("stringId") String stringId, @RequestParam("floatId") Double floatId, @RequestParam("doubleCol") BigDecimal doubleCol, @RequestParam("charId") String charId, @RequestBody @MapTo(Many2oneCompParent.class) Map<String, Object> many2oneCompParentPatch) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Many2oneCompParent editMany2oneCompParent(@RequestParam("stringId") String stringId, @RequestParam("floatId") Double floatId, @RequestParam("doubleCol") BigDecimal doubleCol, @RequestParam("charId") String charId, MultipartHttpServletRequest multipartHttpServletRequest) {
        return this.editMany2oneCompParentAndMultiparts(stringId, floatId, doubleCol, charId, multipartHttpServletRequest);
    }

    @ApiOperation(value = "Updates the Many2oneCompParent instance associated with the given composite-id.")
    @RequestMapping(value = "/composite-id", method = RequestMethod.PUT,  consumes = "multipart/form-data")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Many2oneCompParent editMany2oneCompParentAndMultiparts(@RequestParam("stringId") String stringId, @RequestParam("floatId") Double floatId, @RequestParam("doubleCol") BigDecimal doubleCol, @RequestParam("charId") String charId, MultipartHttpServletRequest multipartHttpServletRequest) { 
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteMany2oneCompParent(@RequestParam("stringId") String stringId, @RequestParam("floatId") Double floatId, @RequestParam("doubleCol") BigDecimal doubleCol, @RequestParam("charId") String charId) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<Many2oneCompChild> findAssociatedMany2oneCompChilds(@RequestParam("stringId") String stringId, @RequestParam("floatId") Double floatId, @RequestParam("doubleCol") BigDecimal doubleCol, @RequestParam("charId") String charId, Pageable pageable) {

        LOGGER.debug("Fetching all associated many2oneCompChilds");
        return many2oneCompParentService.findAssociatedMany2oneCompChilds(stringId, floatId, doubleCol, charId, pageable);
    }

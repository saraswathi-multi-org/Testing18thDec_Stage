 ...
 * @see AllTypes
 */
@Service("NewTestDB.AllTypesService")
@Validated
@EntityService(entityClass = AllTypes.class, serviceId = "NewTestDB")
public class AllTypesServiceImpl implements AllTypesService {
    ...
    @Autowired
    @Qualifier("NewTestDB.AllTypesDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service NewTestDB for table AllTypes to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service NewTestDB for table AllTypes to {} format", options.getExportType());

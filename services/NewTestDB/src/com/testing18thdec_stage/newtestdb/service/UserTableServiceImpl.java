 ...
 * @see UserTable
 */
@Service("NewTestDB.UserTableService")
@Validated
@EntityService(entityClass = UserTable.class, serviceId = "NewTestDB")
public class UserTableServiceImpl implements UserTableService {
    ...
    @Autowired
    @Qualifier("NewTestDB.UserTableDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service NewTestDB for table UserTable to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service NewTestDB for table UserTable to {} format", options.getExportType());

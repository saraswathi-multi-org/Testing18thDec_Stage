...
public interface One2oneParentService {
     ...
     */
    One2oneParent getById(Short one2oneparentId);
     ...
     * @return One2oneParent associated with the given one2oneparentId.
     */
    One2oneParent findById(Short one2oneparentId);
     ...
     */
    List<One2oneParent> findByMultipleIds(List<Short> one2oneparentIds, boolean orderedReturn);
     ...
     * @throws EntityNotFoundException if no One2oneParent is found with given input.
     */
    One2oneParent partialUpdate(Short one2oneparentId, Map<String, Object> one2oneParentPatch);
     ...
     */
    One2oneParent delete(Short one2oneparentId);

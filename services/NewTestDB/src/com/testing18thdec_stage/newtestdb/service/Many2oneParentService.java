...
public interface Many2oneParentService {
     ...
     */
    Many2oneParent getById(String many2oneparentId);
	...
	/**
     * Find and return the list of Many2oneParents by given id's.
     *
     ...
     *
     * @param many2oneparentIds The id's of the Many2oneParent to get; value cannot be null.
     * @param orderedReturn Should the return List be ordered and positional in relation to the incoming ids?
     * @return Many2oneParents associated with the given many2oneparentIds.
     */
    List<Many2oneParent> findByMultipleIds(List<String> many2oneparentIds, boolean orderedReturn);
     ...
     */
    Many2oneParent update(@Valid Many2oneParent many2oneParent);


    /**
     * Partially updates the details of an existing Many2oneParent. It updates only the
     * fields of the existing Many2oneParent which are passed in the many2oneParentPatch.
     *
     * This method overrides the input field values using Server side or database managed properties defined on Many2oneParent if any.
     *
     * @param many2oneparentId The id of the Many2oneParent to be deleted; value cannot be null.
     * @param many2oneParentPatch The partial data of Many2oneParent which is supposed to be updated; value cannot be null.
     * @return The updated Many2oneParent.
     * @throws EntityNotFoundException if no Many2oneParent is found with given input.
     */
    Many2oneParent partialUpdate(String many2oneparentId, Map<String, Object> many2oneParentPatch);
     ...
     */
    Many2oneParent delete(String many2oneparentId);

    /**
     * Deletes an existing Many2oneParent with the given object.
     *
     * @param many2oneParent The instance of the Many2oneParent to be deleted; value cannot be null.
     */
    void delete(Many2oneParent many2oneParent);

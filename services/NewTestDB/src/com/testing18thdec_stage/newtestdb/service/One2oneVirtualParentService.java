...
public interface One2oneVirtualParentService {
     ...
     */
    One2oneVirtualParent getById(String one2onevirtualparentId);
	...
	/**
     * Find and return the list of One2oneVirtualParents by given id's.
     *
     ...
     *
     * @param one2onevirtualparentIds The id's of the One2oneVirtualParent to get; value cannot be null.
     * @param orderedReturn Should the return List be ordered and positional in relation to the incoming ids?
     * @return One2oneVirtualParents associated with the given one2onevirtualparentIds.
     */
    List<One2oneVirtualParent> findByMultipleIds(List<String> one2onevirtualparentIds, boolean orderedReturn);
     ...
     */
    One2oneVirtualParent update(@Valid One2oneVirtualParent one2oneVirtualParent);


    /**
     * Partially updates the details of an existing One2oneVirtualParent. It updates only the
     * fields of the existing One2oneVirtualParent which are passed in the one2oneVirtualParentPatch.
     *
     * This method overrides the input field values using Server side or database managed properties defined on One2oneVirtualParent if any.
     *
     * @param one2onevirtualparentId The id of the One2oneVirtualParent to be deleted; value cannot be null.
     * @param one2oneVirtualParentPatch The partial data of One2oneVirtualParent which is supposed to be updated; value cannot be null.
     * @return The updated One2oneVirtualParent.
     * @throws EntityNotFoundException if no One2oneVirtualParent is found with given input.
     */
    One2oneVirtualParent partialUpdate(String one2onevirtualparentId, Map<String, Object> one2oneVirtualParentPatch);
     ...
     */
    One2oneVirtualParent delete(String one2onevirtualparentId);

    /**
     * Deletes an existing One2oneVirtualParent with the given object.
     *
     * @param one2oneVirtualParent The instance of the One2oneVirtualParent to be deleted; value cannot be null.
     */
    void delete(One2oneVirtualParent one2oneVirtualParent);

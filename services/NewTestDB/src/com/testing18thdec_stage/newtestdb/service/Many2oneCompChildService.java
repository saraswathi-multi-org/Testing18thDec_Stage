...
public interface Many2oneCompChildService {
     ...
     */
    Many2oneCompChild getById(Short many2onecompchildId);
     ...
     */
    List<Many2oneCompChild> findByMultipleIds(List<Short> many2onecompchildIds, boolean orderedReturn);
     ...
     * @throws EntityNotFoundException if no Many2oneCompChild is found with given input.
     */
    Many2oneCompChild partialUpdate(Short many2onecompchildId, Map<String, Object> many2oneCompChildPatch);
     ...
     */
    Many2oneCompChild delete(Short many2onecompchildId);

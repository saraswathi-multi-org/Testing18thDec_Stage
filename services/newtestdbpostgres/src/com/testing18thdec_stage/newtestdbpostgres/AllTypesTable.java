...
public class AllTypesTable implements Serializable {
    ...
    @Id
    @SequenceGenerator(name = "generator", sequenceName = "\"ALL_TYPES_TABLE_PK ID_seq\"" , schema = "public", allocationSize = 1)
    ...
    @Column(name = "`CLOB COL`", nullable = true, length = 8255)
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(getPkId(), allTypesTable.getPkId());
    }

...
@Validated
@EntityService(entityClass = One2oneParent.class, serviceId = "WMSTUDIO")
public class One2oneParentServiceImpl implements One2oneParentService {
    ...
    @Override
    public One2oneParent getById(Byte one2oneparentId) {
    ...
    @Transactional(readOnly = true, value = "WMSTUDIOTransactionManager")
    @Override
    public List<One2oneParent> findByMultipleIds(List<Byte> one2oneparentIds, boolean orderedReturn) {
    ...
    @Transactional(value = "WMSTUDIOTransactionManager")
    @Override
    public One2oneParent partialUpdate(Byte one2oneparentId, Map<String, Object>one2oneParentPatch) {
    ...
    @Transactional(value = "WMSTUDIOTransactionManager")
    @Override
    public One2oneParent delete(Byte one2oneparentId) {
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service WMSTUDIO for table One2oneParent to {} format", options.getExportType());

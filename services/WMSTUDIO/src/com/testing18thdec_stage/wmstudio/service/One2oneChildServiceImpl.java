...
@Validated
@EntityService(entityClass = One2oneChild.class, serviceId = "WMSTUDIO")
public class One2oneChildServiceImpl implements One2oneChildService {
    ...
    public One2oneChild create(One2oneChild one2oneChild) {
        ...
        if(one2oneUcChild != null && Hibernate.isInitialized(one2oneUcChild)) {
            one2oneUcChild.setOne2oneChild(one2oneChild);
        }
    ...
    @Override
    public One2oneChild getById(Byte one2onechildId) {
    ...
    @Transactional(readOnly = true, value = "WMSTUDIOTransactionManager")
    @Override
    public List<One2oneChild> findByMultipleIds(List<Byte> one2onechildIds, boolean orderedReturn) {
    ...
    @Transactional(value = "WMSTUDIOTransactionManager")
    @Override
    public One2oneChild partialUpdate(Byte one2onechildId, Map<String, Object>one2oneChildPatch) {
    ...
    @Transactional(value = "WMSTUDIOTransactionManager")
    @Override
    public One2oneChild delete(Byte one2onechildId) {
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service WMSTUDIO for table One2oneChild to {} format", options.getExportType());

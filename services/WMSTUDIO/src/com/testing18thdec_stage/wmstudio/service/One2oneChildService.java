...
public interface One2oneChildService {
     ...
     */
    One2oneChild getById(Byte one2onechildId);
     ...
     */
    List<One2oneChild> findByMultipleIds(List<Byte> one2onechildIds, boolean orderedReturn);
     ...
     * @throws EntityNotFoundException if no One2oneChild is found with given input.
     */
    One2oneChild partialUpdate(Byte one2onechildId, Map<String, Object> one2oneChildPatch);
     ...
     */
    One2oneChild delete(Byte one2onechildId);

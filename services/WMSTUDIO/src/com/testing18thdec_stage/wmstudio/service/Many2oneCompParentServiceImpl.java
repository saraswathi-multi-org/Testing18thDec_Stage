...
@Validated
@EntityService(entityClass = Many2oneCompParent.class, serviceId = "WMSTUDIO")
public class Many2oneCompParentServiceImpl implements Many2oneCompParentService {
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service WMSTUDIO for table Many2oneCompParent to {} format", options.getExportType());
    ...
    @Transactional(readOnly = true, value = "WMSTUDIOTransactionManager")
    @Override
    public Page<Many2oneCompChild> findAssociatedMany2oneCompChilds(String stringId, Byte byteId, Double floatId, String charId, Pageable pageable) {

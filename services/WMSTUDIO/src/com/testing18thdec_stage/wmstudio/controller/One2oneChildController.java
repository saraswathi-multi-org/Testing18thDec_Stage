...
public class One2oneChildController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public One2oneChild getOne2oneChild(@PathVariable("id") Byte id) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public One2oneChild editOne2oneChild(@PathVariable("id") Byte id, @RequestBody One2oneChild one2oneChild) throws EntityNotFoundException {
        LOGGER.debug("Editing One2oneChild with id: {}" , one2oneChild.getBytePk());

        one2oneChild.setBytePk(id);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteOne2oneChild(@PathVariable("id") Byte id) throws EntityNotFoundException {

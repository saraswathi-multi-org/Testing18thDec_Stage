...
import com.testing18thdec_stage.wmstudio.service.One2oneParentService;
...
public class One2oneParentController {
    ...
    @Autowired
	@Qualifier("WMSTUDIO.One2oneParentService")
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public One2oneParent getOne2oneParent(@PathVariable("id") Byte id) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public One2oneParent editOne2oneParent(@PathVariable("id") Byte id, @RequestBody One2oneParent one2oneParent) throws EntityNotFoundException {
        LOGGER.debug("Editing One2oneParent with id: {}" , one2oneParent.getByteId());

        one2oneParent.setByteId(id);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteOne2oneParent(@PathVariable("id") Byte id) throws EntityNotFoundException {

...
public class One2oneParentController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public One2oneParent getOne2oneParent(@PathVariable("byteId") Byte byteId) {
        LOGGER.debug("Getting One2oneParent with id: {}" , byteId);

        One2oneParent foundOne2oneParent = one2oneParentService.getById(byteId);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public One2oneParent editOne2oneParent(@PathVariable("byteId") Byte byteId, @RequestBody One2oneParent one2oneParent) {
        LOGGER.debug("Editing One2oneParent with id: {}" , one2oneParent.getByteId());

        one2oneParent.setByteId(byteId);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public One2oneParent patchOne2oneParent(@PathVariable("byteId") Byte byteId, @RequestBody @MapTo(One2oneParent.class) Map<String, Object> one2oneParentPatch) {
        LOGGER.debug("Partially updating One2oneParent with id: {}" , byteId);

        One2oneParent one2oneParent = one2oneParentService.partialUpdate(byteId, one2oneParentPatch);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteOne2oneParent(@PathVariable("byteId") Byte byteId) {
        LOGGER.debug("Deleting One2oneParent with id: {}" , byteId);

        One2oneParent deletedOne2oneParent = one2oneParentService.delete(byteId);

...
@ApiOperation(value = "Returns the One2oneVpkUcChildChekcst instance associated with the given composite-id.")
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public One2oneVpkUcChildChekcst getOne2oneVpkUcChildChekcst(@RequestParam("characterCol") String characterCol,@RequestParam("floatCol") Double floatCol,@RequestParam("smallintCol") BigInteger smallintCol,@RequestParam("stringCol") String stringCol,@RequestParam("integerCol") BigInteger integerCol) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteOne2oneVpkUcChildChekcst(@RequestParam("characterCol") String characterCol,@RequestParam("floatCol") Double floatCol,@RequestParam("smallintCol") BigInteger smallintCol,@RequestParam("stringCol") String stringCol,@RequestParam("integerCol") BigInteger integerCol) throws EntityNotFoundException {
    ...
    public Page<One2oneVpkUcChildChekcst> searchOne2oneVpkUcChildChekcstsByQueryFilters( Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering One2oneVpkUcChildChekcsts list");
	...
	@ApiOperation(value = "Returns the total count of One2oneVpkUcChildChekcst instances matching the optional query (q) request param. If query string is too big to fit in GET request's query param, use POST method with application/x-www-form-urlencoded format.")

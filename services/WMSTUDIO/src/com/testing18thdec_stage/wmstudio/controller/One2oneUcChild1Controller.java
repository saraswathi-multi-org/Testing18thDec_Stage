...
public class One2oneUcChild1Controller {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public One2oneUcChild1 getOne2oneUcChild1(@PathVariable("id") Short id) throws EntityNotFoundException {
        LOGGER.debug("Getting One2oneUcChild1 with id: {}" , id);

        One2oneUcChild1 foundOne2oneUcChild1 = one2oneUcChild1Service.getById(id);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public One2oneUcChild1 editOne2oneUcChild1(@PathVariable("id") Short id, @RequestBody One2oneUcChild1 one2oneUcChild1) throws EntityNotFoundException {
        LOGGER.debug("Editing One2oneUcChild1 with id: {}" , one2oneUcChild1.getShortId());

        one2oneUcChild1.setShortId(id);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteOne2oneUcChild1(@PathVariable("id") Short id) throws EntityNotFoundException {
        LOGGER.debug("Deleting One2oneUcChild1 with id: {}" , id);

        One2oneUcChild1 deletedOne2oneUcChild1 = one2oneUcChild1Service.delete(id);
    ...
    public Page<One2oneUcChild1> searchOne2oneUcChild1sByQueryFilters( Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering One2oneUcChild1s list");
	...
	@ApiOperation(value = "Returns the total count of One2oneUcChild1 instances matching the optional query (q) request param. If query string is too big to fit in GET request's query param, use POST method with application/x-www-form-urlencoded format.")

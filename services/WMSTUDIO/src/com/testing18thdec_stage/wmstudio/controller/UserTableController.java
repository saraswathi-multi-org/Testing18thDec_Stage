...
import com.testing18thdec_stage.wmstudio.service.UserTableService;
...
public class UserTableController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public UserTable getUserTable(@PathVariable("id") Integer id) throws EntityNotFoundException {
        LOGGER.debug("Getting UserTable with id: {}" , id);

        UserTable foundUserTable = userTableService.getById(id);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public UserTable editUserTable(@PathVariable("id") Integer id, @RequestBody UserTable userTable) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteUserTable(@PathVariable("id") Integer id) throws EntityNotFoundException {
        LOGGER.debug("Deleting UserTable with id: {}" , id);

        UserTable deletedUserTable = userTableService.delete(id);
    ...
    public Page<UserTable> searchUserTablesByQueryFilters( Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering UserTables list");
	...
	@ApiOperation(value = "Returns the total count of UserTable instances matching the optional query (q) request param. If query string is too big to fit in GET request's query param, use POST method with application/x-www-form-urlencoded format.")

...
public class Many2oneCompChildController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Many2oneCompChild getMany2oneCompChild(@RequestParam("doubleId") BigDecimal doubleId, @RequestParam("byteId") Byte byteId, @RequestParam("charId") String charId) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Many2oneCompChild editMany2oneCompChild(@RequestParam("doubleId") BigDecimal doubleId, @RequestParam("byteId") Byte byteId, @RequestParam("charId") String charId, @RequestBody Many2oneCompChild many2oneCompChild) {
	...
	@ApiOperation(value = "Partially updates the  Many2oneCompChild instance associated with the given composite-id.")
	@RequestMapping(value = "/composite-id", method = RequestMethod.PATCH)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Many2oneCompChild patchMany2oneCompChild(@RequestParam("doubleId") BigDecimal doubleId, @RequestParam("byteId") Byte byteId, @RequestParam("charId") String charId, @RequestBody @MapTo(Many2oneCompChild.class) Map<String, Object> many2oneCompChildPatch) {

        Many2oneCompChildId many2onecompchildId = new Many2oneCompChildId();
        many2onecompchildId.setDoubleId(doubleId);
        many2onecompchildId.setByteId(byteId);
        many2onecompchildId.setCharId(charId);
        LOGGER.debug("Partially updating Many2oneCompChild with id: {}" , many2onecompchildId);

        Many2oneCompChild many2oneCompChild = many2oneCompChildService.partialUpdate(many2onecompchildId, many2oneCompChildPatch);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteMany2oneCompChild(@RequestParam("doubleId") BigDecimal doubleId, @RequestParam("byteId") Byte byteId, @RequestParam("charId") String charId) {
